...
<font color = #FF0000 size=5 > <i>[网址由[chat.nnup.fun](https://chat.nnup.fun)更改到[gpt.nnup.fun](https://gpt.nnup.fun),暂时两个网址都可以用，建议使用新网址，旧网址不定时更换，由于隐私保护和技术限制，不会保留原网址数据。]</i> </font>  
