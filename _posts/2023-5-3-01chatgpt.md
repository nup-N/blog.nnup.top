...
访问链接：[gpt.nnup.fun](https://gpt.nnup.fun/)  
<i><font color = #FF0000 size=5 >[网址由[chat.nnup.fun](https://chat.nnup.fun)更改到[gpt.nnup.fun](https://gpt.nnup.fun),暂时两个网址都可以用，强烈建议使用新网址，旧网址不定时废弃，由于隐私保护和技术限制，不会保留原网址数据。]</font></i>   

***<font color=red size=5>[网址由chat.nnup.fun更改到gpt.nnup.fun,暂时两个网址都可以用，强烈建议使用新网址，旧网址不定时废弃，由于隐私保护和技术限制，不会保留原网址数据。]</font>***   
1.无需科学上网，国内直连使用。  
